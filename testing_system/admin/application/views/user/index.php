...
<div class='grid_area'>
    ...
    <div class="tooolbars">
        ...
        <?php if (common::update_permit()): ?>
            ...
            <button title="user/user_status/active" class="jstatus_button">Activate</button>
            <button title="user/user_status/inactive" class="jstatus_button">Inactive</button>
			<button title="user/delete_all_user" class="jdelete_button">Delete All</button>
        <?php endif; ?>
    </div>
    <hr />
    <?php echo $grid_data ?>
